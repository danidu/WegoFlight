...
public class TravelportFlightProvider implements FlightAggregatorProvider {
    ...
    public List<FlightSearchResponse.FlightOption> retryFallbackSearch(FlightSearchRequest request, Exception e) {
        logger.warn("[TRAVELPORT] Retry exhausted - Request: Origin={}, Destination={}, DepartureDate={}, Attempts: 3, Error: {}", 
        ...
        throw new RuntimeException("Travelport API retry exhausted: " + e.getMessage(), e);
    }
